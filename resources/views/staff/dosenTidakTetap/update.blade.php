            ...
            <div class="col-lg-10">
                ...
                <div class="card">
                    <div class="card-header bg-primary">
                        <h4 class="card-title">Update Dosen Tidak Tetap</h4>
                    </div>
                    <div class="card-body">
                        <p class="card-text"></p>
                        <form class="form" method="POST" action="{{ route('dosenTidakTetap.edit', $dosen->id) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <input name="pps" type="text" id="pps" class="form-control" value="{{ $dosen->pps }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <input name="bk" type="text" id="bk" class="form-control" value="{{ $dosen->bk }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <input name="ja" type="text" id="ja" class="form-control" value="{{ $dosen->ja }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <input name="mk" type="text" id="mk" class="form-control" value="{{ $dosen->mk }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <input name="kmk" type="text" id="kmk" class="form-control" value="{{ $dosen->kmk }}">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="form-actions col-6 d-flex justify-content-end">
                                    <button type="submit" class="btn btn-primary btn-round px-5 mr-3">Submit</button>
