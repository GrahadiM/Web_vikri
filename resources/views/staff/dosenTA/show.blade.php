                        ...
                        @csrf
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input disabled name="total_mahasiswa" id="total_mahasiswa" class="form-control" type="text" value="{{ $dosen->total_mahasiswa }}">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="form-actions col-6 d-flex justify-content-end">
                                    ...
                                    <a href="{{ route('dosenPembimbingTA.edit', $dosen->id) }}" class="btn btn-primary btn-round px-5 mr-3">Edit</a>
