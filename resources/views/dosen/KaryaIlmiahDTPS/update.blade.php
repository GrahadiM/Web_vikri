        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form" method="POST" action="{{ route('Karya-IlmiahDTPS.update', $item->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input name="judul" id="judul" class="form-control" type="text" value="{{ $item->judul }}">
