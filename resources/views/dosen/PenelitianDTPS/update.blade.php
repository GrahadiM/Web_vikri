        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form" method="POST" action="{{ route('Penelitian-DTPS.update', $item->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input name="sumber" id="sumber" class="form-control" type="text" value="{{ $item->sumber }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input name="total_judul" id="total_judul" class="form-control" type="text" value="{{ $item->total_judul }}">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="form-actions col-6 d-flex justify-content-end">
                                    ...
                                    <a href="{{ route('Penelitian-DTPS.index') }}" class="btn btn-danger btn-round px-5">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
