        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form" method="POST" action="{{ route('EWMP-DTPT.store') }}" enctype="multipart/form-data">
                        @csrf
                        {{-- @method('PUT') --}}
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group row">
                                            <label for="total_sks" class="col-md-2 col-form-label text-md-left">Jumlah SKS yang diajar semester ini</label>
                                            <div class="col-md-10">
                                                <input name="total_sks" id="total_sks" class="form-control" type="text">
                                                <p class="text-danger">{{ $errors->first("total_sks") }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
