        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form" method="POST" action="{{ route('Publikasi-IlmiahDTPS.store') }}" enctype="multipart/form-data">
                        @csrf
                        {{-- @method('PUT') --}}
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group row">
                                            <label for="jenis" class="col-md-2 col-form-label text-md-left">Jenis Publikasi</label>
                                            <div class="col-md-10">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="form-actions col-6 d-flex justify-content-end">
                                    ...
                                    <a href="{{ route('Publikasi-IlmiahDTPS.index') }}" class="btn btn-danger btn-round px-5">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
